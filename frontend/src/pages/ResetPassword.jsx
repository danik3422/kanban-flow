...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    const validateToken = async () => {
      ...
      try {
        const { data } = await axiosInstance.get('/auth/password-reset/validate', {
          params: { token },
        })
  ...
  const shouldShowCheckingState = isPasswordReset && !isTokenValid && isValidatingToken
      ...
      <div className='auth-layout reset-layout'>
        <section className='auth-intro'>
          <div className='auth-intro-copy'>
            ...
            <p>We will help you get back in without losing the rhythm of your work.</p>
          </div>
        ...
        <section className='auth-form-panel'>
          <div className='auth-form-heading'>
            <p className='eyebrow'>{isPasswordReset ? 'New password' : 'Reset password'}</p>
            <h2>{isPasswordReset ? 'Choose a new password.' : 'Need a fresh start?'}</h2>
            <p>
              {isPasswordReset
          ...
          {isSubmitted ? (
            <div className='reset-success'>
              ...
              <h3>{isPasswordReset ? 'Password updated' : 'Request submitted'}</h3>
              <p>
                {isPasswordReset
