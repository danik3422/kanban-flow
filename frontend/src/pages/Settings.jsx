	...
	return (
		<main className='account-page'>
			...
			<div className='settings-grid'>
				...
				<section className='account-page-card settings-card'><div className='settings-card-heading'><span className='settings-icon'><ShieldCheck size={18} /></span><div><h2>Security</h2><p>Keep your account and workspace protected.</p></div></div><ChangePasswordPanel /><div className='security-2fa'><div><strong>Two-factor authentication</strong><p>Authenticator app setup will be available once email delivery is configured.</p></div><span>Coming soon</span></div></section>
			</div>
