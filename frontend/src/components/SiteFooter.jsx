	...
	return (
		<footer className='site-footer'>
			<div className='footer-identity'>
				<div className='footer-brand'><span className='brand-mark'>K</span><strong>KanbanHub</strong></div>
				<p>© {year} KanbanHub. Built by Danylo Syloats.</p>
			</div>
			<nav className='footer-links' aria-label='Footer links'>
				<a href='mailto:support@kanbanhub.app'><Mail size={14} /> support@kanbanhub.app</a>
